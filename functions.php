...
/* ===================================
	 registrar campos (metaboxes)
	 =================================== */

add_action( 'cmb2_init', 'movies_register_demo_metabox' );
...
function get_resumen( $object, $field_name, $request ) {
    return get_post_meta( $object[ 'id' ], "movies_resumen", true );
}
...
function get_duracion( $object, $field_name, $request ) {
    return get_post_meta( $object[ 'id' ], "movies_duracion", true );
}

function get_anyo( $object, $field_name, $request ) {
    return get_post_meta( $object[ 'id' ], "movies_year", true );
}

function get_trailer( $object, $field_name, $request ) {
    return get_post_meta( $object[ 'id' ], "movies_trailer", true );
}

/* ===================================
	 código original de twenty seventeen
	 =================================== */
